...
/**
  @page DMAInterruptMethod AN3070 DMAInterruptMethod Readme file
  
  @verbatim
  ******************** (C) COPYRIGHT 2010 STMicroelectronics *******************
  * @file DMAInterruptMethod/readme.txt 
  * @author  MCD Application Team
  * @version  V1.0.0
  * @date  01/04/2010
  * @brief  Description of the AN3070 Application note's DMAInterruptMethod.
  ******************************************************************************
...
DMA transmit complete interrupt and the transmit complete of the USART to meet
the RS485 & IO-Link timing specification.
...
@par Directory contents 
  ...
  - DMAInterruptMethod/inc/stm32f10x_conf.h  Library Configuration file
  - DMAInterruptMethod/src/stm32f10x_it.c    Interrupt handlers
  - DMAInterruptMethod/inc/stm32f10x_it.h    Interrupt handlers header file
  - DMAInterruptMethod/src/main.c            Main program
...
@par Hardware and Software environment
  ...
  - This example has been tested with STMicroelectronics STM3210B-EVAL  evaluation 
    ...
    board except the STM3210C-EVAL board because the USART1 is not available on the
    board.
...
In order to load the DMAInterruptMethod code, you have do the following:
  
- RVMDK (v4.00)
    - Open the DMAInterruptMethod.uvopt project
 ...
 - EWARMv5 (v5.40) 
    - Open the DMAInterruptMethod.eww workspace.
 ...
 - RIDE (RIDE7)
    - Open the DMAInterruptMethod.rprj project.
 ...
 - HiTOP (v5.31)
    ...
    - Browse to open the DMAInterruptMethod.htp
