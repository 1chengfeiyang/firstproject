/**
  ******************************************************************************
  * @file    app_stm32_adafruit_spi_lcd.c
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    29-August-2014
  * @brief   This file includes the LCD driver for adafruit 1.8" TFT shield.  
  *
  * @note	This file is a copy of stm32_adafruit_spi_lcd.c where only the clear screen
  * 		during initialization has been removed as this takes too much time and does not bring much benefit
  *
  ******************************************************************************
  * @attention
  *
...
void LCD_ADAFRUIT_Init(void)
{
  ...
  /* LCD_Clear(LCD_COLOR_WHITE); */		/**< Remove to remove latency on each initialization */
